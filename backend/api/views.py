...
class StoreProductViewSet(viewsets.ModelViewSet):
    ...
    def seed_default_products(self):
        default_items = [
            {
                'id': 'prod-01', 'name': 'Clavier Mécanique Ergonomique Pro', 'brand': 'Logitech', 'category': 'Accessoires',
                ...
                'status': 'on_order', 'featured': True, 'visible': True, 'price': 0
            },
            {
                'id': 'prod-02', 'name': 'Souris Sans Fil MX Master 3S', 'brand': 'Logitech', 'category': 'Accessoires',
            ...
            {
                'id': 'prod-03', 'name': 'Casque Audio Studio Réduction de Bruit Active', 'brand': 'Sony', 'category': 'Accessoires',
                ...
                'status': 'on_order', 'featured': False, 'visible': True, 'price': 0
            },
            {
                'id': 'prod-04', 'name': 'SSD Externe Ultra-Rapide 1 To USB-C', 'brand': 'SanDisk', 'category': 'Accessoires',
            ...
            {
                'id': 'prod-05', 'name': 'Câble Imprimante Blindé USB-A vers USB-B (3m)', 'brand': 'UGREEN', 'category': 'Impression',
            ...
            {
                'id': 'prod-06', 'name': 'Adaptateur USB 3.0 OTG Aluminium', 'brand': 'Anker', 'category': 'Impression',
            ...
            {
                'id': 'prod-07', 'name': 'Clé USB 3.2 Metal 64 Go Métallique', 'brand': 'Kingston', 'category': 'Impression',
            ...
            {
                'id': 'prod-08', 'name': 'Tapis de Souris XXL Bureau Signature (90x40cm)', 'brand': 'Hadara Studio', 'category': 'Graphisme',
            ...
            {
                'id': 'prod-09', 'name': 'Support Laptop Pliable en Aluminium Ergonomique', 'brand': 'Baseus', 'category': 'Graphisme',
            ...
            {
                'id': 'prod-10', 'name': 'Hub USB-C Multiport 7-en-1 Aluminium 4K', 'brand': 'UGREEN', 'category': 'Graphisme',
            ...
            {
                'id': 'prod-11', 'name': 'Chargeur Rapide GaN 65W Multi-Ports USB-C/A', 'brand': 'Anker', 'category': 'Électronique',
            ...
            {
                'id': 'prod-12', 'name': 'Câble Tressé Renforcé Type-C vers Type-C (2m)', 'brand': 'UGREEN', 'category': 'Électronique',
