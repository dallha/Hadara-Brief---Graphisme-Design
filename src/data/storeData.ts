...
export const DEFAULT_STORE_PRODUCTS: StoreProduct[] = [
  ...
  },
  {
    ...
    priceFCFA: 0,
    stockStatus: 'in_stock',
    description: 'Capteur optique 8000 DPI haute précision, défilement électromagnétique et ergonomie optimale pour graphistes.',
  ...
  },
  {
    ...
    description: 'Casque circum-aural avec isolation phonique active de pointe, microphone HD et autonomie 30 heures.',
  ...
  },
  {
    ...
    priceFCFA: 0,
    stockStatus: 'in_stock',
    description: 'Gaine en nylon tressé haute résistance supportant 100W PD et transfert de données ultra-rapide.',
    imageUrl: 'https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?auto=format&fit=crop&w=600&q=80',
    badge: '✅ En Stock',
    isActive: true,
    createdAt: '2026-08-02'
